        ...
        <div className="modal-overlay" onClick={onClose}>
            <div className="modal-content sub-modal" onClick={e => e.stopPropagation()}>
                ...
                <div className="sub-header">
                    ...
                    <p className="sub-subtitle">Đồng hành cùng chuyên gia 24/7</p>
                </div>
                ...
                <div className="sub-body">
                    ...
                    <div className="sub-benefits">
                        ...
                        <ul>
                            <li>✅ <strong>Review Video:</strong> Gửi video con chơi 1 lần/tuần để chuyên gia nhận xét và sửa lỗi.</li>
